...
public class ReflectUtil {
     ...
     * @see #on(Class)
     */
    public static ReflectUtil on(String name) throws ReflectException {
     ...
     * @see #on(Class)
     */
    public static ReflectUtil on(String name, ClassLoader classLoader) throws ReflectException {
    ...
    private static ReflectUtil on(Constructor<?> constructor, Object... args) throws ReflectException {
        try {
    ...
    private static ReflectUtil on(Method method, Object object, Object... args) throws ReflectException {
        try {
            accessible(method);
     ...
     */
    public ReflectUtil set(String name, Object value) throws ReflectException {
        try {
     ...
     * @throws ReflectException
     */
    public ReflectUtil field(String name) throws ReflectException {
        try {
            Field field = field0(name);
     ...
     * @throws ReflectException
     */
    public ReflectUtil call(String name) throws ReflectException {
     ...
     * @throws ReflectException
     */
    public ReflectUtil call(String name, Object... args) throws ReflectException {
     ...
     * @throws ReflectException
     */
    public ReflectUtil create() throws ReflectException {
     ...
     * @throws ReflectException
     */
    public ReflectUtil create(Object... args) throws ReflectException {
        Class<?>[] types = types(args);
     ...
     * @throws ReflectException
     */
    public ReflectUtil callBest(String name, Object... args) throws ReflectException {
        Class<?>[] types = types(args);
        Class<?> type = type();
